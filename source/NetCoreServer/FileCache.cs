...
public class FileCache : IDisposable
{
    ...
    private class FileCacheEntry
    {
        ...
        {
            _prefix = prefix.Replace('\\', '/').TrimEnd('/');
        ...
        {
            var key = e.FullPath.Replace('\\', '/').Replace(entry._path, entry._prefix).TrimEnd('/');
            var file = e.FullPath.Replace('\\', '/').TrimEnd('/');
        ...
        {
            var oldKey = e.OldFullPath.Replace('\\', '/').Replace(entry._path, entry._prefix).TrimEnd('/');
            var oldFile = e.OldFullPath.Replace('\\', '/').TrimEnd('/');
            var newKey = e.FullPath.Replace('\\', '/').Replace(entry._path, entry._prefix).TrimEnd('/');
            var newFile = e.FullPath.Replace('\\', '/').TrimEnd('/');
