...
namespace tests
{
    public class EchoUdsClient : UdsClient
    {
        public bool Connected { get; set; }
        public bool Disconnected { get; set; }
        public bool Errors { get; set; }

        public EchoUdsClient(string patch) : base(patch) {}
    ...
    public class EchoUdsSession : UdsSession
    {
        public bool Connected { get; set; }
        public bool Disconnected { get; set; }
        public bool Errors { get; set; }
    ...
    public class EchoUdsServer : UdsServer
    {
        ...
        public EchoUdsServer(string patch) : base(patch) {}
    ...
    {
        [Fact(DisplayName = "UDS server test")]
        public void TcpServerTest()
        {
            var patch = AppDomain.CurrentDomain.BaseDirectory + @"\udsSocket.sock";

            // Create and start Echo server
            var server = new EchoUdsServer(patch);
            Assert.True(server.Start());
            while (!server.IsStarted)
                Thread.Yield();

            // Create and connect Echo client
            var client = new EchoUdsClient(patch);
        ...
        [Fact(DisplayName = "UDS server multicast test")]
        public void TcpServerMulticastTest()
        {
            ...
            // Create and connect Echo client
            var client1 = new EchoUdsClient(patch);
            ...
            // Create and connect Echo client
            var client2 = new EchoUdsClient(patch);
            ...
            // Create and connect Echo client
            var client3 = new EchoUdsClient(patch);
        ...
        [Fact(DisplayName = "UDS server random test")]
